...
class InstantiationClashException(
    private val problemVar: String, private val varToInst: String,
    private val formula: Formula
) :
    Exception() {
    override val message: String
        get() = "Collision during instantiation because " + problemVar + " appears in " +
